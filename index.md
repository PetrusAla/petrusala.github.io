<!DOCTYPE html>
        ...
        <head>
            <meta charset="UTF-8">
            <title>Petrus Alapiha Web-teht&auml;v&auml;</title>
            <style>
...
.markdown-alert.markdown-alert-caution .markdown-alert-title {
  color: var(--color-caution);
        ...
        <body class="vscode-body vscode-light">
            <h2 id="petrus-alapiha-web-tehtävä">Petrus Alapiha Web-tehtävä</h2>
<h3 id="tehtävä-1">tehtävä 1</h3>
<p>Writing in Markdown is <em>not</em> that hard!
<em>not</em>
<em>not</em></p>
<h3 id="tehtävä-2">tehtävä 2</h3>
<p>I <strong>will</strong> complete these lessons!</p>
<h3 id="tehtävä-3">tehtävä 3</h3>
<p><em>&quot;Of course,&quot;</em> she whispered. Then, she shouted: &quot;All I need is <strong>a little moxie!&quot;</strong></p>
<h3 id="tehtävä-4">tehtävä 4</h3>
<p>If you're thinking to yourself, <strong><em>This is unbelievable</em></strong>, you'd probably be right.</p>
<h3 id="tehtävä-5">tehtävä 5</h3>
...
<h3 id="tehtävä-6">tehtävä 6</h3>
<h4 id="colombian-symbolism-in-one-hundred-years-of-solitude">Colombian Symbolism in <em>One Hundred Years of Solitude</em></h4>
<p>Here's some words about the book <em>One Hundred Years...</em>.</p>
<h3 id="tehtävä-7">tehtävä 7</h3>
<p><a href="https://www.google.com">search for it</a></p>
<h3 id="tehtävä-8">tehtävä 8</h3>
<p>You're <a href="https://www.dailykitten.com"><strong>really, really</strong></a> going to want to see this.</p>
<h3 id="tehtävä-9">tehtävä 9</h3>
<h4 id="the-latest-news-from-the-bbc">The Latest News from <a href="https://www.bbc.com/news">the BBC</a></h4>
<h3 id="tehtävä-10">tehtävä 10</h3>
<p>Do you want to see something fun <a href="https://www.zombo.com">a fun place</a>?</p>
<p>Well, do I have the website for you <a href="https://www.stumbleupon.com">another fun place</a>!</p>
<p><a href="https://www.zombo.com">a fun place</a>
<a href="https://www.stumbleupon.com">another fun place</a></p>
<h3 id="tehtävä-11">tehtävä 11</h3>
<p><img src="https://upload.wikimedia.org/wikipedia/commons/5/56/Tiger.50.jpg" alt="A pretty tiger"></p>
<h3 id="tehtävä-12">tehtävä 12</h3>
...
<h3 id="tehtävä-13">tehtävä 13</h3>
...
<h3 id="tehtävä-14">tehtävä 14</h3>
<blockquote>
...
<h3 id="tehtävä-15">tehtävä 15</h3>
<blockquote>
...
<h3 id="tehtävä-16">tehtävä 16</h3>
<ul>
<li>Flour</li>
<li>Cheese</li>
<li>Tomatoes</li>
</ul>
<h3 id="tehtävä-17">tehtävä 17</h3>
<ol>
<li>Cut the cheese</li>
<li>Slice the tomatoes</li>
<li>Rub the tomatoes in flour</li>
</ol>
<h3 id="tehtävä-18">tehtävä 18</h3>
<ul>
...
<h3 id="tehtävä-19">tehtävä 19</h3>
<ul>
<li>Calculus
<ul>
<li>A professor</li>
...
<h3 id="tehtävä-20">tehtävä 20</h3>
<ol>
<li>
<p>Cut the cheese</p>
...
<h3 id="tehtävä-21">tehtävä 21</h3>
...
<h3 id="tehtävä-22">tehtävä 22</h3>
<ol>
<li>
<p>Crack three eggs over a bowl.<br>
Now, you're going to want to crack the eggs in such a way that you don't make a mess.<br>
If you <em>do</em> make a mess, use a towel to clean it up!</p>
</li>
<li>
<p>Pour a gallon of milk into the bowl.<br>
